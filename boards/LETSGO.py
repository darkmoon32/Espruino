...
info = {
 ...
 'default_console' : "EV_SERIAL6", # FIXME: This was S2 because of pin conflict. Not sure if it's really an issue?
 'variables' : 5450,
 'binary_name' : 'espruino_%v_letsgo.bin',
 'build' : {
   'optimizeflags' : '-Os',
   'libraries' : [
     'NET',
...
devices = {
  ...
  'GREEN3' : { 'pin' : 'B12'},
  'GREEN4' : { 'pin' : 'A8'},
  'BTN1' : { 'pin' : 'E10', 'pinstate' : 'IN_PULLDOWN' },
  'BTN2' : { 'pin' : 'C5', 'pinstate' : 'IN_PULLDOWN' },
  'BTN3' : { 'pin' : 'C4', 'pinstate' : 'IN_PULLDOWN' },
  'BTN4' : { 'pin' : 'C3', 'pinstate' : 'IN_PULLDOWN' },
  'BTN5' : { 'pin' : 'C2', 'pinstate' : 'IN_PULLDOWN' },
  'PWM1' : { 'pin' : 'E9'},
  'PWM2' : { 'pin' : 'E11'},
  'PWM3' : { 'pin' : 'E13'},
  'PWM4' : { 'pin' : 'E14'},
